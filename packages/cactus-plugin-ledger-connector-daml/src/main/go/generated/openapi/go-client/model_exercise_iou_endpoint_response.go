...
type ExerciseIOUEndpointResponse struct {
	...
	Events []ExerciseIOUEndpointResponseEventsInner `json:"events,omitempty"`
}
...
func (o *ExerciseIOUEndpointResponse) GetEvents() []ExerciseIOUEndpointResponseEventsInner {
	if o == nil || IsNil(o.Events) {
		var ret []ExerciseIOUEndpointResponseEventsInner
		return ret
	}
	return o.Events
}
...
// and a boolean to check if the value has been set.
func (o *ExerciseIOUEndpointResponse) GetEventsOk() ([]ExerciseIOUEndpointResponseEventsInner, bool) {
	if o == nil || IsNil(o.Events) {
		return nil, false
	}
...
// SetEvents gets a reference to the given []ExerciseIOUEndpointResponseEventsInner and assigns it to the Events field.
func (o *ExerciseIOUEndpointResponse) SetEvents(v []ExerciseIOUEndpointResponseEventsInner) {
	o.Events = v
}
