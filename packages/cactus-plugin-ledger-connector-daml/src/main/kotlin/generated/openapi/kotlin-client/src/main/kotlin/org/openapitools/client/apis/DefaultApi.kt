...
import org.openapitools.client.models.GetPartiesInvolvedResponse
...
class DefaultApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
     ...
     * This method creates a simple iou countract
     * 
     * @param exerciseIOUEndpointRequest Request body for creation of iou
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun exerciseIou(exerciseIOUEndpointRequest: ExerciseIOUEndpointRequest) : ExerciseIOUEndpointResponse {
        val localVarResponse = exerciseIouWithHttpInfo(exerciseIOUEndpointRequest = exerciseIOUEndpointRequest)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun exerciseIouWithHttpInfo(exerciseIOUEndpointRequest: ExerciseIOUEndpointRequest) : ApiResponse<ExerciseIOUEndpointResponse?> {
        val localVariableConfig = exerciseIouRequestConfig(exerciseIOUEndpointRequest = exerciseIOUEndpointRequest)
    ...
    /**
     * To obtain the request config of the operation exerciseIou
     *
     * @param exerciseIOUEndpointRequest Request body for creation of iou
     * @return RequestConfig
     */
    fun exerciseIouRequestConfig(exerciseIOUEndpointRequest: ExerciseIOUEndpointRequest) : RequestConfig<ExerciseIOUEndpointRequest> {
    ...
    /**
     * This method starts a new instance which will get all the parties involved
     * 
     * @param body Request body for getting the parties involved
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getPartiesInvolved(body: kotlin.Any) : GetPartiesInvolvedResponse {
        val localVarResponse = getPartiesInvolvedWithHttpInfo(body = body)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as GetPartiesInvolvedResponse
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
     ...
     * 
     * @param body Request body for getting the parties involved
     * @return ApiResponse<GetPartiesInvolvedResponse?>
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getPartiesInvolvedWithHttpInfo(body: kotlin.Any) : ApiResponse<GetPartiesInvolvedResponse?> {
        val localVariableConfig = getPartiesInvolvedRequestConfig(body = body)

        return request<kotlin.Any, GetPartiesInvolvedResponse>(
            localVariableConfig
        )
    }
     ...
     * @return RequestConfig
     */
    fun getPartiesInvolvedRequestConfig(body: kotlin.Any) : RequestConfig<kotlin.Any> {
