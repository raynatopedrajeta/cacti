...
export class ExerciseIOUEndpoint implements IWebServiceEndpoint {
  ...
  async handleRequest(req: Request, res: Response): Promise<void> {
    const fnTag = "ExerciseIOUEndpointRequest#handleRequest()";
    const verbUpper = this.getVerbLowerCase().toUpperCase();
    this.log.debug(`${verbUpper} ${this.getPath()}`);
    console.log("Exercise IOU Parameter---")
    // console.log(req.body)
    // const reqBody = req.body as ExerciseIOUEndpointRequest;
    // console.log(reqBody)
    ...
    try {
      ...
      console.log("check the request here------")
      // console.log(req)
